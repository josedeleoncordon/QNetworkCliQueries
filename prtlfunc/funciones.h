...
//convierte una busqueda de puertos de acceso en texto con indentacion para guardar como tabla
QString puertosDeAccesoATabla(QString pais,QList<MacBuscando*> lstARPs);

//convierte una busqueda de puertos de acceso en texto con indentacion para guardar como tabla. Ruta completa
