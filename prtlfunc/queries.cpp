...
QPRTLFUNCSHARED_EXPORT QDataStream& operator<<(QDataStream& out, const Queries* query)
{
    //guardar
...
QPRTLFUNCSHARED_EXPORT QDataStream& operator>>(QDataStream& in, Queries*& query)
{
    //abrir
...
QPRTLFUNCSHARED_EXPORT QDebug operator<<(QDebug dbg, const Queries &info)
{
...
QPRTLFUNCSHARED_EXPORT QDataStream& operator<<(QDataStream& out, const LstQueries* lstquery)
{
    //guardar
    out << lstquery->pais;
...
QPRTLFUNCSHARED_EXPORT QDataStream& operator>>(QDataStream& in, LstQueries*& lstquery)
{
    //abrir
...
QPRTLFUNCSHARED_EXPORT QDebug operator<<(QDebug dbg, const LstQueries &info)
{
